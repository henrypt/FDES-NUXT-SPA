    ...
    <v-row justify="space-around">
      ...
      <v-col cols="3" class="pdr-0 d-sm-none d-md-none d-lg-flex">
        <v-card style="width:100%;">
          ...
          >
            <v-tab class="subtitle-2 font-weight-bold">计算结果</v-tab>
            <v-tab class="subtitle-2 font-weight-bold">稳定点列表</v-tab>
                ...
                <v-simple-table dense fixed-header>
                  <template v-slot:default>
                    <caption
                      class="text-left caption font-weight-bold sub_title1 pl-2 py-2"
                    >
                      <label v-text="calcInfo.title"></label>
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="text-left">点个数</th>
                        <th class="text-left">占用比例</th>
                        <th class="text-left">提示</th>
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="4" class="border-bottom-solid">&nbsp;</td>
                      </tr>
                    </tfoot>
                  </template>
                </v-simple-table>
